...
const LANDING_KEYWORDS = [
  ...
  "каталог авто комплектации",
];

export const metadata: Metadata = {
  title: "ImportCRM — CRM и калькулятор растаможки для импорта авто из Китая, Кореи и Киргизии",
  description:
    "CRM для импорта автомобилей: калькулятор растаможки, каталог новых авто с комплектациями и актуализацией цен, раздел «Клиенты», кабинет клиента, карта автовоза и Telegram. Проще Битрикса. От 10 000 ₽/мес или 100 000 ₽ разово, 30 дней бесплатно.",
  ...
  openGraph: {
    ...
    description:
      "Калькулятор растаможки, каталог новых авто, раздел «Клиенты», кабинет клиента и карта автовоза в одной системе. Для компаний, которые возят авто из Китая, Кореи и Киргизии.",
  ...
  twitter: {
    ...
    description:
      "Калькулятор растаможки, каталог новых авто, раздел «Клиенты», кабинет клиента и отслеживание автовоза. 30 дней бесплатно.",
  },
  robots: {
    index: true,
    follow: true,
