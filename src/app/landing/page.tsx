...
export const metadata: Metadata = {
  ...
  description:
    "CRM для импорта автомобилей: калькулятор растаможки и утильсбора, раздел «Клиенты», кабинет клиента, карта автовоза и Telegram. Проще Битрикса. От 10 000 ₽/мес или 100 000 ₽ разово, 30 дней бесплатно.",
  ...
  openGraph: {
    ...
    description:
      "Калькулятор растаможки, раздел «Клиенты», кабинет клиента и карта автовоза в одной системе. Для компаний, которые возят авто из Китая, Кореи и Киргизии.",
  ...
  twitter: {
    ...
    description:
      "Калькулятор растаможки, раздел «Клиенты», кабинет клиента и отслеживание автовоза. 30 дней бесплатно.",
  },
  robots: {
    index: true,
    follow: true,
