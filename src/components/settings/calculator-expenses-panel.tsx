    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription className="mt-1.5">
          ...
          Можно добавить свою страну — она считает как Китай. Остальные страны при сохранении не
          меняются. Системные роли влияют на расчёт (ВТБ, инвойс Кореи); доп. расходы просто входят
          в итог.
        </CardDescription>
      </CardHeader>
      <CardContent>
